...
const handleEIP1559Support = async () => {
  console.log('INSIDE handleEIP1559Support');
  ...
  console.log({ supported, block, accounts });
...
const initializeContracts = () => {
  console.log('in initializeContracts', provider);
  try {
    ...
    //   ethersProvider.getSigner(),
    // );
    // console.log('hstFactory ', hstFactory);
...
const updateFormElements = () => {
  ...
  const accountButtonsDisabled = !isMetaMaskConnected();
...
const initialize = async () => {
  console.log('INITIALIZING ', window.ethereum);
